...
# NeoKylin add begin
Patch0: anaconda-13.21.215-neokylin-enhancement-addInstallEverything.patch
Patch1: anaconda-13.21.215-neokylin-fix-cannotChinesize.patch
Patch2: anaconda-13.21.215-neokylin-enhancement-customInstallationTaskSelection.patch
Patch3: anaconda-13.21.215-neokylin-fix-errorWriteGrubConf.patch
Patch4: anaconda-13.21.215-neokylin-enhancement-supportGtkGif.patch
Patch5: anaconda-13.21.215-neokylin-customDefaultThemeForAnaconda.patch
Patch6: anaconda-13.21.215-neokylin-custom-logos-release.patch
Patch7: anaconda-13.21.215-neokylin-setDefaultLangAndTimezone.patch
Patch8: anaconda-13.21.215-neokylin-enhancement-customNeokylinInstallationInterface.patch
Patch9: anaconda-13.21.215-neokylin-upgradeForNeokylinProduct.patch
Patch10: anaconda-13.21.215-neokylin-enhancement-quickinstall.patch
Patch11: anaconda-13.21.215-neokylin-enhancement-strenglenPasswordCheck.patch
Patch12: anaconda-13.21.215-neokylin-custom-cancelGetAddons.patch
Patch13: anaconda-13.21.215-neokylin-custom-resetDefaultOptions.patch
Patch14: anaconda-13.21.215-neokylin-po.patch
Patch15: anaconda-13.21.215-neokylin-selinux-firewall-strenglenForText.patch
Patch16: anaconda-13.21.215-neokylin-grub-partitionDialogGui-runlevel-rootSize-parttype-grpsForText.patch
Patch17: anaconda-13.21.215-neokylin-dispatchBack-upgrade-repo.patch
Patch18: anaconda-13.21.215-neokylin-enhancement-oneClickInstallation.patch
Patch19: anaconda-13.21.215-neokylin-chineseLocalizationForOneclick.patch
Patch20: anaconda-13.21.215-neokylin-chineseLocalizationForPassword.patch
Patch21: anaconda-13.21.215-neokylin-disable-selinux.patch
Patch22: anaconda-13.21.215-neokylin-delete-doublepack.patch
Patch23: anaconda-13.21.215-neokylin-disable-sameupgrade-and-stayon.patch
patch24: anaconda-13.21.215-neokylin-translation-pkginstall.patch
Patch25: anaconda-13.21.215-neokylin-tasklist-trans-and-fixcrashbug.patch
Patch26: anaconda-13.21.215-neokylin-exception-save-opts-and-translation.patch
Patch27: anaconda-13.21.215-neokylin-fix-translations.patch
Patch28: anaconda-13.21.215-neokylin-write-crypttime-and-run-rpmimportkey.patch
Patch29: anaconda-13.21.215-neokylin-translation-productname.patch
Patch30: anaconda-13.21.215-neokylin-change-efi.patch
Patch31: anaconda-13.21.215-neokylin-import-13.21.216.patch
Patch32: anaconda-13.21.215-neokylin-fix-partition-efi.patch
Patch33: anaconda-13.21.215-neokylin-fix-gtk-warnings.patch
Patch34: anaconda-13.21.215-neokylin-lang-keymap.patch
Patch35: anaconda-13.21.215-neokylin-fix-task-reback.patch
Patch36: anaconda-13.21.215-neokylin-fix-VEaddBase-checkEFI.patch
Patch37: anaconda-13.21.215-neokylin-fix-VE.patch
Patch38: anaconda-13.21.215-neokylin-fix-VE-from-xialei.patch
Patch39: anaconda-13.21.215-neokylin-fix-hwnotsupport.patch
Patch40: anaconda-13.21.215-neokylin-fix-installall-error-reback.patch
Patch41: anaconda-13.21.215-neokylin-fix-titile-partly.patch
Patch42: anaconda-13.21.215-neokylin-fix-quickinstall.patch
# Neokylin end
...
%changelog
* Mon Nov 24 2014 Guo jianxing <jianxing.guo@cs2c.om.cn> - 13.21.215-1.ns6.10
- Patch42: fix quickinstall error.

* Mon Oct 20 2014 Guo jianxing <jianxing.guo@cs2c.om.cn> - 13.21.215-1.ns6.09
- Patch41:fix bug: the title only display partly.

* Tue Oct 14 2014 Guo jianxing <jianxing.guo@cs2c.om.cn> - 13.21.215-1.ns6.08
- Patch40:fix bug: after installAllPkg error, return to reselect, can't auto select defaults. 

* Fri Oct 10 2014 Guo jianxing <jianxing.guo@cs2c.om.cn> - 13.21.215-1.ns6.07
- Patch39: fix RedHat info of not supported hardware

* Tue May 27 2014 Guo jianxing <jianxing.guo@cs2c.om.cn> - 13.21.215-1.ns6.06
- Patch37: fix VE welcome picutre; fix select pkgs crash while text installo.

* Thu May 22 2014 Guo jianxing <jianxing.guo@cs2c.om.cn> - 13.21.215-1.ns6.05
- Patch36: fix VE add base group; fix check EFI crash.

* Mon May 19 2014 Guo jianxing <jianxing.guo@cs2c.om.cn> - 13.21.215-1.ns6.04
- Patch34: make lang & keymap transfer to anaconda
- Patch35: fix tasklist: select Database or Virtual, go next then reback, Basic selected.

* Thu May 15 2014 Guo jianxing <jianxing.guo@cs2c.om.cn> - 13.21.215-1.ns6.03
- Patch30: change efi path for neokylin.
- Patch31: import 13.21.216 patch, initrd add dm-raid45 which is needed to support fake RAID5
- Patch32: fix check boot_part for EFI; before checkBootRequest(boot), add check disk labeltype for EFI. 
-          fix some translation; add some dmsetup output to tty5; 
-          fix tasklist has two selected while reback tasklist from custom page.
- Patch33: fix some gtk warnings, then fix some widget flashing at partition page.

* Fri May 09 2014 Guo jianxing <jianxing.guo@cs2c.om.cn> - 13.21.215-1.ns6.02
- Patch21: disable selinux.
- Patch22: delete doubule pack label.
- Patch23: disable upgrade from same version, stayon the screen while check error.
- Patch24: fix translation while packages installing.
- Patch25: translation of tasklist, fix crash whiel edit repo, expend height of tasklist.
- Patch26: set save exception options, add python-meh.po for exception dialog's translation.
- Patch27: fix some translations.
- Patch28: add write encrypt time file for license, run rpm import key file.
- Patch29: add productName translation, fix some translation.

* Fri Mar 07 2014 Xia Lei <lei.xia@cs2c.com.cn> - 13.21.215-1.ns6.01
- Enhancement: add a function that is installing everything packages.(patch0)
- Resolves: fix can't Chinesize problem by deleting po/stamp-po file.(patch1)
- use the neokylin.py to replace the fedora.py and rhel.py, 
  achieve neokylin's Installation Task Selection,
  set "Basic server" to default selected task.(patch2)
- Resolves: fix error write grub.conf(bootloaderExtraArgs).(patch3) 
- Enhancement: support gtk gif(patch4)
- custom default theme for anaconda
  - add mouse theme(patch5)
  - maintain gtk2-engines, metacity, system-gnome-theme packages for anaconda
    they are differences from desktop environment, because we use different
    default theme between anaconda and desktop environment.
- variable packages in scripts/upd-instroot has $brandpkgname-logos and 
  $brandpkgname-release, the $brandpkgname should be "neokylin", should not be
  "neokylin linux advanced server", so I make the patch6(patch6)
- set default language and timezone(patch7)
- custom neokylin installation interface(patch8)
- upgrade for neokylin product(patch9)
- support for quickinstall(patch10)
- strenglen password check(patch11)
- cancel to get addons, because neokylin has no addons(patch12)
- make reviewButton to be actived when autopart_type gui is shown(patch13)
- reset default option for parttype(patch13)
- reset default option to make it always to be custom radio on 
  the tasksel gui(patch13) 
- Chinese localization(patch14)
- default close off selinux and firewall(patch15)
- strenglen password check for text installation(patch15), this could be 
  merger to patch11.
- grub.cfg, always set the timeout to be 5(patch16)
- detele the "Fill all space _up to (MB):" radio button,
  delete the spin button.(patch16)
- reset default runlevel for neokylin installation(patch16)
- reset the suggestion value of root size(patch16)
- custom neokylin default parttype selection for text installtion(patch16)
- custom neokylin software groups for text installation(patch16)
- custom neokylin demand, we can back two steps.(patch17)
- strengthen neokylin upgrade mechanism(patch17)
- fix bug(you can add/edit repo, and use the existed repoName)(patch17)
- fix bug about upgrade, but i am not clear about this bug,
  I moves it from ns6.4 to ns6.5.(patch17)
- support for one click installation based kickstart
  add two steps, the first is to set hostname, 
  the second is to show a prompt dialog.(patch18)
- chinese localization for one click(patch19)
- chinese localization for password(patch20)
